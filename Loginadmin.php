...
if(isset($_POST['Login_btn'])){
    ...
    if(mysqli_num_rows($result) == 1){
      ...
      $_SESSION['firstname'] = $information[0]['firstname'];
      $_SESSION['id'] = $username;
      $_SESSION['hotelid'] = $information[0]['hotelid'];
...
<body class="black white-text">
    <div class="container">
    <h3 class="center">Admins Login</h3>
    <div class="center">
        <form class="col l6 s12" action = "Loginadmin.php" method = "post">
          <div class="row">
            <div class="input-field col s12">
              <input placeholder = "Username" name="username" type="text" class="textInput">
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
