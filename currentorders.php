...
$sql = "SELECT * from orders WHERE orders.hotelid = $hotelid AND orders.status = 0;";
...
<body class="white-text black">
    <div class="container">
        <h3>Greetings , <?php echo htmlspecialchars( $_SESSION['firstname']) ?> <br> Following are all active orders placed at your Hotel </h3>
