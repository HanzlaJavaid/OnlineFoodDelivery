...
<div class = "modal white-text grey darken-4 " id = "change_q">
        <form action="orderpage.php?hotelid=<?php echo $_SESSION['hotelid']?>&itemid=<?php echo $id?>" method="post">
        <div class="row">
            <div class="input-field col s12">
              <input placeholder = "Enter Quantity" name="quantity" type="number" class="textInput">
            </div>
            <div class="input-field col s12">
              <input placeholder = "Enter Location" name="loc" type="text" class="textInput" value = "<?php echo htmlspecialchars($location) ?>">
            </div>
            <div class="input-field col s12">
